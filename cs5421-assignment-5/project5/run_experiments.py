...
p0 = subprocess.Popen(['python', 'run_sums.py', str(1), args.I], stdout=subprocess.PIPE)
correct_sum = ast.literal_eval(p0.communicate()[0])[0]

## Create subprocess to run the transactions paralelly
p1 = subprocess.Popen(['python', 'run_sums.py', str(args.S), args.I], stdout=subprocess.PIPE)
p2 = subprocess.Popen(['python', 'run_all_exchanges.py', str(args.E), str(args.P), args.I], stdout=subprocess.PIPE)
p1.wait()
p2.wait()
